...
import TelephoneMask from './components/TelephoneMask'
...
const JoinUsForm = (props: JoinUsFormProp) => {
  ...
  const [user, setUser] = useState<JoinUsFormParams>({ ...initialUser })
  ...
  return (
    <form noValidate autoComplete="off" className={clsx(classes.root,className)} {...rest}>
      ...
      <TextField className={classes.inputField} 
        ...
        label='Nome'
      />
      <Typography className={classes.fieldTitle}>Sua marca</Typography>
      <TextField className={classes.inputField} 
        error={hasError('brandName')}
        helperText={hasError('brandName') ? formState.errors.brandName[0] : null}
        onChange={event => handleFieldChange(event, 'brandName', event.target.value)}
